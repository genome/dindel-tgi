...
struct FileReaderIterator;       	// "projects/library/seqan/file/file_filereader.h"(405)
...
class SAMFileMeta;       	// "projects/library/seqan/file/file_format_sam.h"(341)

//____________________________________________________________________________
// SAMMeta

class SAMMeta;       	// "projects/library/seqan/file/file_format_sam.h"(350)
...
template <typename TSpec> struct TagSBAM_;       	// "projects/library/seqan/file/file_format_sam.h"(38)
...
struct _BAM;       	// "projects/library/seqan/file/file_format_sam.h"(53)
...
template <typename T> struct _FileReader_Types;       	// "projects/library/seqan/file/file_filereader.h"(413)
...
struct _SAM;       	// "projects/library/seqan/file/file_format_sam.h"(45)
...
typedef Tag<TagSBAM_<_BAM> > const BAM;       	// "projects/library/seqan/file/file_format_sam.h"(54)
...
typedef Tag<TagSBAM_<_SAM> > const SAM;       	// "projects/library/seqan/file/file_format_sam.h"(46)
...
template <typename TValue, typename TFormat, typename TFile, typename TSpec> inline void _FileReaderString_construct(String<TValue, FileReader<TFormat, TFile, TSpec> > & me);       	// "projects/library/seqan/file/file_filereader.h"(257)

//____________________________________________________________________________
// _FileReaderString_findblock

template <typename TValue, typename TFormat, typename TFile, typename TSpec, typename TPosition> inline unsigned int _FileReaderString_findblock(String<TValue, FileReader<TFormat, TFile, TSpec> > & me, TPosition pos);       	// "projects/library/seqan/file/file_filereader.h"(236)

//____________________________________________________________________________
// _FileReaderString_isValidBlock

template <typename TValue, typename TFormat, typename TFile, typename TSpec, typename TUint> inline bool _FileReaderString_isValidBlock(String<TValue, FileReader<TFormat, TFile, TSpec> > & me, TUint block_number);       	// "projects/library/seqan/file/file_filereader.h"(274)

//____________________________________________________________________________
// _FileReaderString_loadComplete

template <typename TValue, typename TFormat, typename TFile, typename TSpec> inline void _FileReaderString_loadComplete(String<TValue, FileReader<TFormat, TFile, TSpec> > & me);       	// "projects/library/seqan/file/file_filereader.h"(291)

//____________________________________________________________________________
// _FileReaderString_loadblock

template <typename TValue, typename TFormat, typename TFile, typename TSpec, typename TPosition> inline void _FileReaderString_loadblock(String<TValue, FileReader<TFormat, TFile, TSpec> > & me, TPosition blocknum);       	// "projects/library/seqan/file/file_filereader.h"(170)
...
template <typename TValue, typename TFormat, typename TFile, typename TSpec> inline TFile & _dataFile(String<TValue, FileReader<TFormat, TFile, TSpec> > & me);       	// "projects/library/seqan/file/file_filereader.h"(159)
...
CharString _intToStr(const int &i);       	// "projects/library/seqan/file/file_format_sam.h"(328)

//____________________________________________________________________________
// _map

template <typename TValue, typename TConfig, typename TSize > inline bool _map(String<TValue, MMap<TConfig> > &me, TSize new_capacity);       	// "projects/library/seqan/file/string_mmap.h"(303)
template <typename TValue, typename TConfig, typename TSize > inline bool _map(String<TValue, MMap<TConfig> > &me, TSize new_capacity);       	// "projects/library/seqan/file/string_mmap.h"(468)
...
int _pack(CharString key);       	// "projects/library/seqan/file/file_format_sam.h"(407)
...
CharString _unpack(int n);       	// "projects/library/seqan/file/file_format_sam.h"(414)

//____________________________________________________________________________
// _writeAlignment

template <typename TFile, typename TGapsSpec, typename TIDString, typename TSAMSpec> inline void _writeAlignment( TFile & target, Align<DnaString, TGapsSpec> const & source, int ref, int read, const CharString refName, const CharString readName, BAM);       	// "projects/library/seqan/file/file_format_sam.h"(322)

//____________________________________________________________________________
// _write_additional_meta

template <typename TFile> inline void _write_additional_meta(TFile & target, String<Triple<CharString, char, CharString> > const & meta, Tag<TagSBAM_<_SAM> > );       	// "projects/library/seqan/file/file_format_sam.h"(139)

//____________________________________________________________________________
// _write_alignment

template <typename TFile, typename TGapsSpec, typename TMeta> inline void _write_alignment(TFile & target, Align<DnaString,TGapsSpec> const & source, const int ref_row_pos_int, const int read_row_pos_int, const TMeta meta, Tag<TagSBAM_<_SAM> > );       	// "projects/library/seqan/file/file_format_sam.h"(166)
...
template <typename TContainer> inline bool atBegin(Iter<TContainer, FileReaderIterator> & it);       	// "projects/library/seqan/file/file_filereader.h"(763)
template <typename TContainer> inline bool atBegin(Iter<TContainer, FileReaderIterator> const & it);       	// "projects/library/seqan/file/file_filereader.h"(769)
...
template <typename TContainer> inline bool atEnd(Iter<TContainer, FileReaderIterator> & it);       	// "projects/library/seqan/file/file_filereader.h"(748)
template <typename TContainer> inline bool atEnd(Iter<TContainer, FileReaderIterator> const & it);       	// "projects/library/seqan/file/file_filereader.h"(754)
...
template <typename TContainer> inline TContainer & container(Iter<TContainer, FileReaderIterator> & it);       	// "projects/library/seqan/file/file_filereader.h"(576)
template <typename TContainer> inline TContainer & container(Iter<TContainer, FileReaderIterator> const & it);       	// "projects/library/seqan/file/file_filereader.h"(582)
...
CharString getName(const SAMMeta meta);       	// "projects/library/seqan/file/file_format_sam.h"(394)

//____________________________________________________________________________
// getRName

CharString getRName(const SAMMeta meta);       	// "projects/library/seqan/file/file_format_sam.h"(398)

//____________________________________________________________________________
// getValue

template <typename TContainer> inline typename GetValue<Iter<TContainer, FileReaderIterator> >::Type getValue(Iter<TContainer, FileReaderIterator> & it);       	// "projects/library/seqan/file/file_filereader.h"(536)
template <typename TContainer> inline typename GetValue<Iter<TContainer, FileReaderIterator> >::Type getValue(Iter<TContainer, FileReaderIterator> const & it);       	// "projects/library/seqan/file/file_filereader.h"(547)
...
template <typename TContainer> inline void goEnd(Iter<TContainer, FileReaderIterator> & it);       	// "projects/library/seqan/file/file_filereader.h"(736)
...
template <typename TContainer> inline void goNext(Iter<TContainer, FileReaderIterator> & it);       	// "projects/library/seqan/file/file_filereader.h"(648)
...
template <typename TContainer> inline void goPrevious(Iter<TContainer, FileReaderIterator> & it);       	// "projects/library/seqan/file/file_filereader.h"(680)
...
template <typename TValue, typename TFormat, typename TFile, typename TSpec> inline void const * id(String<TValue, FileReader<TFormat, TFile, TSpec> > const & me);       	// "projects/library/seqan/file/file_filereader.h"(304)
...
template <typename TContainer> inline bool operator!= (Iter<TContainer, FileReaderIterator> const & left, Iter<TContainer, FileReaderIterator> const & right);       	// "projects/library/seqan/file/file_filereader.h"(794)
...
template <typename TContainer, typename TIntegral> inline Iter<TContainer, FileReaderIterator> operator+ (Iter<TContainer, FileReaderIterator> const & left, TIntegral right);       	// "projects/library/seqan/file/file_filereader.h"(851)
template <typename TContainer, typename TIntegral> inline Iter<TContainer, FileReaderIterator> operator+ (TIntegral left, Iter<TContainer, FileReaderIterator> const & right);       	// "projects/library/seqan/file/file_filereader.h"(859)

//____________________________________________________________________________
// operator+=

template <typename TContainer, typename TIntegral> inline Iter<TContainer, FileReaderIterator> & operator+= (Iter<TContainer, FileReaderIterator> & left, TIntegral right);       	// "projects/library/seqan/file/file_filereader.h"(872)

//____________________________________________________________________________
// operator-

template <typename TContainer, typename TIntegral> inline Iter<TContainer, FileReaderIterator> operator- (Iter<TContainer, FileReaderIterator> const & left, TIntegral right);       	// "projects/library/seqan/file/file_filereader.h"(890)
template <typename TContainer> inline typename Difference<Iter<TContainer, FileReaderIterator> >::Type operator- (Iter<TContainer, FileReaderIterator> const & left, Iter<TContainer, FileReaderIterator> const & right);       	// "projects/library/seqan/file/file_filereader.h"(901)

//____________________________________________________________________________
// operator-=

template <typename TContainer, typename TIntegral> inline Iter<TContainer, FileReaderIterator> & operator-= (Iter<TContainer, FileReaderIterator> & left, TIntegral right);       	// "projects/library/seqan/file/file_filereader.h"(914)

//____________________________________________________________________________
// operator<

template <typename TContainer> inline bool operator< (Iter<TContainer, FileReaderIterator> const & left, Iter<TContainer, FileReaderIterator> const & right);       	// "projects/library/seqan/file/file_filereader.h"(807)
...
template <typename TContainer> inline bool operator<= (Iter<TContainer, FileReaderIterator> const & left, Iter<TContainer, FileReaderIterator> const & right);       	// "projects/library/seqan/file/file_filereader.h"(829)

//____________________________________________________________________________
// operator==

template <typename TContainer> inline bool operator== (Iter<TContainer, FileReaderIterator> const & left, Iter<TContainer, FileReaderIterator> const & right);       	// "projects/library/seqan/file/file_filereader.h"(781)
bool operator== (SAMMeta first, SAMMeta second);       	// "projects/library/seqan/file/file_format_sam.h"(388)
template <typename TFileLeft, typename TDataLeft, typename TMetaLeft, typename TFormatLeft, typename TFileRight, typename TDataRight, typename TMetaRight, typename TFormatRight> inline bool operator== (FileFormat<TFileLeft, TDataLeft, TMetaLeft, TFormatLeft> const & left, FileFormat<TFileRight, TDataRight, TMetaRight, TFormatRight> const & right);       	// "projects/library/seqan/file/file_format.h"(319)
...
template <typename TContainer> inline bool operator> (Iter<TContainer, FileReaderIterator> const & left, Iter<TContainer, FileReaderIterator> const & right);       	// "projects/library/seqan/file/file_filereader.h"(816)

//____________________________________________________________________________
// operator>=

template <typename TContainer> inline bool operator>= (Iter<TContainer, FileReaderIterator> const & left, Iter<TContainer, FileReaderIterator> const & right);       	// "projects/library/seqan/file/file_filereader.h"(838)
...
template <typename TContainer> inline typename Position<Iter<TContainer, FileReaderIterator> >::Type position(Iter<TContainer, FileReaderIterator> const & it);       	// "projects/library/seqan/file/file_filereader.h"(591)
...
template <typename TFile, typename TGapsSpec> void read(TFile & file, Align<DnaString, TGapsSpec> & data, SAMMeta & meta, SAM);       	// "projects/library/seqan/file/file_format_sam.h"(434)
template <typename TFile> void read(TFile & file, String<Pair<CharString, String<Pair<CharString, CharString> > > > & data, SAM);       	// "projects/library/seqan/file/file_format_sam.h"(448)
...
void setName(SAMMeta meta, CharString name);       	// "projects/library/seqan/file/file_format_sam.h"(403)
...
template <typename TContainer, typename TPos> inline void setPosition(Iter<TContainer, FileReaderIterator> & it, TPos pos);       	// "projects/library/seqan/file/file_filereader.h"(616)
...
template <typename TValue, typename TFormat, typename TFile, typename TSpec, typename TPos> inline TValue value(String<TValue, FileReader<TFormat, TFile, TSpec> > & me, TPos pos);       	// "projects/library/seqan/file/file_filereader.h"(315)
template <typename TContainer> inline typename Reference<Iter<TContainer, FileReaderIterator> >::Type value(Iter<TContainer, FileReaderIterator> & it);       	// "projects/library/seqan/file/file_filereader.h"(561)
template <typename TContainer> inline typename Reference<Iter<TContainer, FileReaderIterator> >::Type value(Iter<TContainer, FileReaderIterator> const & it);       	// "projects/library/seqan/file/file_filereader.h"(567)
...
template <typename TFile, typename TGapsSpec, typename TIDString, typename TSAMSpec> inline void write(TFile & target, Align<DnaString, TGapsSpec> const & source, TIDString const & myId, Tag<TagSBAM_<TSAMSpec> > );       	// "projects/library/seqan/file/file_format_sam.h"(60)
template <typename TFile, typename TGapsSpec, typename TIDString, typename TSAMSpec> inline void write(TFile & target, Align<DnaString, TGapsSpec> const & source, const int refPosition, TIDString const & myId, Tag<TagSBAM_<TSAMSpec> > );       	// "projects/library/seqan/file/file_format_sam.h"(72)
template <typename TFile, typename TGapsSpec, typename TIDString, typename TMeta, typename TSAMSpec> inline void write(TFile & target, Align<DnaString, TGapsSpec> const & source, const int refPosition, const String<TMeta> metas, const String<unsigned int> IDs, TIDString const &, Tag<TagSBAM_<TSAMSpec> > );       	// "projects/library/seqan/file/file_format_sam.h"(114)
template <typename TFile> inline void write(TFile & target, const String<Pair<CharString, String<Pair<CharString, CharString> > > > & meta, const Tag<TagSBAM_<_SAM> > & sam);       	// "projects/library/seqan/file/file_format_sam.h"(582)
...
template <typename TFile> inline void write_header_line(TFile & target, const CharString & cat, const String<Pair<CharString, CharString> > & meta, Tag<TagSBAM_<_SAM> > );       	// "projects/library/seqan/file/file_format_sam.h"(558)
