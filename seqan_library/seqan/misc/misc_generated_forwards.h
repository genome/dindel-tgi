...
class CommandLineOption;       	// "projects/library/seqan/misc/misc_cmdparser.h"(85)

//____________________________________________________________________________
// CommandLineParser

class CommandLineParser;       	// "projects/library/seqan/misc/misc_cmdparser.h"(440)
...
struct OptionType;       	// "projects/library/seqan/misc/misc_cmdparser.h"(63)
...
inline bool _allMandatorySet(CommandLineParser const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(888)

//____________________________________________________________________________
// _assignOptionValue

template <typename TErrorStream> bool _assignOptionValue(CommandLineParser & me, unsigned option_index, CharString const & val, unsigned argNo, TErrorStream & estream);       	// "projects/library/seqan/misc/misc_cmdparser.h"(913)
template <typename TErrorStream> inline bool _assignOptionValue(CommandLineParser & me, unsigned option_index, CharString const & val, TErrorStream & estream);       	// "projects/library/seqan/misc/misc_cmdparser.h"(954)

//____________________________________________________________________________
// _convertOptionValue

inline bool _convertOptionValue(CommandLineOption const & opt, bool & dst, CharString const & src);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1158)
inline bool _convertOptionValue(CommandLineOption const & opt, int & dst, CharString const & src);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1166)
inline bool _convertOptionValue(CommandLineOption const & opt, unsigned int & dst, CharString const & src);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1174)
inline bool _convertOptionValue(CommandLineOption const & opt, float & dst, CharString const & src);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1182)
inline bool _convertOptionValue(CommandLineOption const & opt, double & dst, CharString const & src);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1190)
template <typename TObject> inline bool _convertOptionValue(CommandLineOption const & opt, TObject & dst, CharString const & src);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1200)
...
template <typename TChar> inline bool _isDigit(TChar const c);       	// "projects/library/seqan/misc/misc_cmdparser.h"(21)

//____________________________________________________________________________
// _isDouble

template <typename TString> inline bool _isDouble(TString const s);       	// "projects/library/seqan/misc/misc_cmdparser.h"(28)

//____________________________________________________________________________
// _isInt

template <typename TString> inline bool _isInt(TString const s);       	// "projects/library/seqan/misc/misc_cmdparser.h"(49)

//____________________________________________________________________________
// _parseAppName

inline CharString _parseAppName(CharString const & candidate);       	// "projects/library/seqan/misc/misc_cmdparser.h"(898)

//____________________________________________________________________________
// _printStringSet

template <typename TStringSet, typename TStream> inline void _printStringSet(TStringSet const & set, TStream & target);       	// "projects/library/seqan/misc/misc_cmdparser.h"(663)

//____________________________________________________________________________
// _title

template <typename TStream> inline void _title(CommandLineParser const & me, TStream & target);       	// "projects/library/seqan/misc/misc_cmdparser.h"(704)

//____________________________________________________________________________
// _usage

template <typename TStream> inline void _usage(CommandLineParser const & me, TStream & target);       	// "projects/library/seqan/misc/misc_cmdparser.h"(674)

//____________________________________________________________________________
// _writeOptName

template <typename TStream> inline void _writeOptName(TStream & target, CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(399)

//____________________________________________________________________________
// addArgumentText

inline CommandLineOption addArgumentText(CommandLineOption const & opt, CharString const & text);       	// "projects/library/seqan/misc/misc_cmdparser.h"(193)

//____________________________________________________________________________
// addHelpLine

template <typename TString> inline void addHelpLine(CommandLineParser & me, TString const & line);       	// "projects/library/seqan/misc/misc_cmdparser.h"(560)

//____________________________________________________________________________
// addLine

template <typename TString> inline void addLine(CommandLineParser & me, TString const & line);       	// "projects/library/seqan/misc/misc_cmdparser.h"(553)

//____________________________________________________________________________
// addOption

inline void addOption(CommandLineParser & me, CommandLineOption const & opt);       	// "projects/library/seqan/misc/misc_cmdparser.h"(525)

//____________________________________________________________________________
// addSection

template <typename TString> inline void addSection(CommandLineParser & me, TString const & line);       	// "projects/library/seqan/misc/misc_cmdparser.h"(567)

//____________________________________________________________________________
// addTitleLine

template <typename TString> inline void addTitleLine(CommandLineParser & me, TString const & line);       	// "projects/library/seqan/misc/misc_cmdparser.h"(575)

//____________________________________________________________________________
// addUsageLine

inline void addUsageLine(CommandLineParser & me, CharString const & line);       	// "projects/library/seqan/misc/misc_cmdparser.h"(602)

//____________________________________________________________________________
// addVersionLine

template <typename TString> inline void addVersionLine(CommandLineParser & me, TString const & line);       	// "projects/library/seqan/misc/misc_cmdparser.h"(582)
...
inline Size<String<CharString> >::Type argumentCount(CommandLineParser const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1357)

//____________________________________________________________________________
// argumentText

inline CharString argumentText(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(368)
...
inline CharString const & getArgumentValue(CommandLineParser const & me, unsigned position);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1333)

//____________________________________________________________________________
// getArgumentValues

inline String<CharString> const & getArgumentValues(CommandLineParser const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1342)

//____________________________________________________________________________
// getOptionValue

inline CharString const & getOptionValue(CommandLineParser const & me, unsigned option_index, unsigned argNo);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1138)
inline CharString const & getOptionValue(CommandLineParser const & me, unsigned option_index);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1150)

//____________________________________________________________________________
// getOptionValueLong

template <typename TValue> inline bool getOptionValueLong(CommandLineParser & me, CharString const & longName, unsigned argNo, TValue & val);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1278)
template <typename TValue> inline bool getOptionValueLong(CommandLineParser & me,CharString const & longName, TValue & val);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1296)

//____________________________________________________________________________
// getOptionValueShort

template <typename TValue> inline bool getOptionValueShort(CommandLineParser & me, CharString const & shortName, unsigned argNo, TValue & val);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1223)
template <typename TValue> inline bool getOptionValueShort(CommandLineParser & me, CharString const & shortName, TValue & val);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1241)
inline String<CharString> const & getOptionValueShort(CommandLineParser & me,CharString const & shortName);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1247)

//____________________________________________________________________________
// getOptionValues

inline String<CharString> const & getOptionValues(CommandLineParser const & me, unsigned option_index);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1128)

//____________________________________________________________________________
// getOptionValuesLong

inline String<CharString> const & getOptionValuesLong(CommandLineParser & me, CharString const & longName);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1302)
...
inline bool hasOptionLong(CommandLineParser const & me, CharString const & _long);       	// "projects/library/seqan/misc/misc_cmdparser.h"(619)

//____________________________________________________________________________
// hasOptionShort

inline bool hasOptionShort(CommandLineParser const & me, CharString const & _short);       	// "projects/library/seqan/misc/misc_cmdparser.h"(635)

//____________________________________________________________________________
// help

template <typename TStream> inline void help(CommandLineParser const & me, TStream & target);       	// "projects/library/seqan/misc/misc_cmdparser.h"(743)
inline void help(CommandLineParser const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(817)

//____________________________________________________________________________
// helpText

inline CharString & helpText(CommandLineOption & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(284)
inline const CharString & helpText(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(289)
...
inline const bool isBooleanOption(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(318)

//____________________________________________________________________________
// isDoubleOption

inline const bool isDoubleOption(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(324)

//____________________________________________________________________________
// isHiddenOption

inline const bool isHiddenOption(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(336)

//____________________________________________________________________________
// isIntOption

inline const bool isIntOption(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(330)

//____________________________________________________________________________
// isLabelOption

inline const bool isLabelOption(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(348)

//____________________________________________________________________________
// isOptionList

inline const bool isOptionList(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(354)

//____________________________________________________________________________
// isOptionMandatory

inline const bool isOptionMandatory(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(342)

//____________________________________________________________________________
// isSetLong

inline bool isSetLong(CommandLineParser & me,CharString const & longName);       	// "projects/library/seqan/misc/misc_cmdparser.h"(876)

//____________________________________________________________________________
// isSetShort

inline bool isSetShort(CommandLineParser & me, CharString const & shortName);       	// "projects/library/seqan/misc/misc_cmdparser.h"(857)

//____________________________________________________________________________
// isStringOption

inline const bool isStringOption(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(312)
...
inline CharString & longName(CommandLineOption & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(213)
inline const CharString & longName(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(218)
...
template <typename TStream> inline TStream & operator<< (TStream & target, CommandLineOption const & source);       	// "projects/library/seqan/misc/misc_cmdparser.h"(426)
...
template <typename TErrorStream> bool parse(CommandLineParser & me, int argc, const char *argv[], TErrorStream & estream);       	// "projects/library/seqan/misc/misc_cmdparser.h"(973)
inline bool parse(CommandLineParser & me, int argc, const char *argv[]);       	// "projects/library/seqan/misc/misc_cmdparser.h"(1119)
...
inline void requiredArguments(CommandLineParser & me, unsigned count);       	// "projects/library/seqan/misc/misc_cmdparser.h"(653)

//____________________________________________________________________________
// setHelpText

inline void setHelpText(CommandLineOption & me, CharString const & newHelp);       	// "projects/library/seqan/misc/misc_cmdparser.h"(304)

//____________________________________________________________________________
// setLongName

inline void setLongName(CommandLineOption & me, CharString const & newName);       	// "projects/library/seqan/misc/misc_cmdparser.h"(233)

//____________________________________________________________________________
// setOptionType

inline void setOptionType(CommandLineOption & me, const int _newOpt);       	// "projects/library/seqan/misc/misc_cmdparser.h"(360)

//____________________________________________________________________________
// setShortName

inline void setShortName(CommandLineOption & me, CharString const & newName);       	// "projects/library/seqan/misc/misc_cmdparser.h"(268)

//____________________________________________________________________________
// shortHelp

template <typename TStream> inline void shortHelp(CommandLineParser const & me, TStream & target);       	// "projects/library/seqan/misc/misc_cmdparser.h"(720)

//____________________________________________________________________________
// shortName

inline CharString & shortName(CommandLineOption & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(249)
inline const CharString & shortName(CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(254)
...
template <typename TStream> inline void version(CommandLineParser const & me, TStream & target);       	// "projects/library/seqan/misc/misc_cmdparser.h"(834)
inline void version(CommandLineParser const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(840)

//____________________________________________________________________________
// write

template <typename TStream> inline void write(TStream & target, CommandLineOption const & me);       	// "projects/library/seqan/misc/misc_cmdparser.h"(415)
